...
import com.sportify.BtnClickListener;
import com.sportify.CountdownDialogbox;
import com.sportify.DAO.DATAMachine;
import com.sportify.DAO.Machine;
import com.sportify.DAO.Profile;
import com.sportify.DAO.record.DATAFonte;
import com.sportify.DAO.record.DATARecord;
import com.sportify.DAO.record.DATAStatic;
import com.sportify.DAO.record.Record;
import com.sportify.DAO.program.DATAProgram;
import com.sportify.DAO.program.Program;
import com.sportify.MainActivity;
import com.sportify.RecordEditorDialogbox;
...
import com.sportify.utils.Keyboard;
import com.sportify.utils.OnCustomEventListener;
import com.sportify.utils.UnitConverter;
import com.sportify.enums.ProgramRecordStatus;
...
public class RecordArrayAdapter extends ArrayAdapter{
    ...
    private final DATAProgram mDbWorkout;
    ...
    public RecordArrayAdapter(Activity activity, Context context, List<Record> objects, DisplayType displayType, BtnClickListener clickAction2) {
        ...
        mDbRecord = new DATARecord(context);
        mDbWorkout = new DATAProgram(context);
    }
    ...
    private void launchCountdown(Record record){
        if (record.getRestTime()>0) {
            DATAMachine mDbMachine = new DATAMachine(getContext());
            ...
            if (record.getExerciseType()==ExerciseType.STRENGTH) {
                DATAFonte mDbBodyBuilding = new DATAFonte(getContext());
                ...
                DATAStatic mDbIsometric = new DATAStatic(getContext());
    ...
    private String distanceToString(float distance, DistanceUnit unit) {
        ...
        if (unit == DistanceUnit.MILES) {
            distance = UnitConverter.KmToMiles(distance);
