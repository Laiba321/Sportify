...
import com.sportify.views.WorkoutValuesInputView;
...
public class RecordEditorDialogbox extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_editor_record);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_cancel) {
            ...
            DATARecord daoRecord = new DATARecord(mActivity.getBaseContext());
            switch (mRecord.getExerciseType()) {
                case CARDIO:
                    ...
                    if (mWorkoutValuesInput.getDistanceUnit()== DistanceUnit.MILES) {
                        distance = UnitConverter.MilesToKm(distance);
                    }
