...
public class Writer {
	private java.io.Writer outputStream = null;
	...
	public Writer(java.io.Writer outputStream, char delimiter) {
	...
	public Writer(OutputStream outputStream, char delimiter, Charset charset) {
	...
	private void checkClosed() throws IOException {
		if (closed) {
			...
			"This instance of the Writer class has already been closed.");
		}
	}
